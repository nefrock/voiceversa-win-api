...
namespace Sipek.Sip
{
  ...
  public class pjsipPresenceAndMessaging : IPresenceAndMessaging
  {
    ...
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl,EntryPoint="dll_addBuddy")]
    private static extern int dll_addBuddy(string uri, bool subscribe);
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl,EntryPoint="dll_removeBuddy")]
    private static extern int dll_removeBuddy(int buddyId);
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl,EntryPoint="dll_sendMessage")]
    private static extern int dll_sendMessage(int buddyId, string uri, string message);
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl,EntryPoint="dll_setStatus")]
