...
namespace Sipek.Sip
{
  ...
  internal class pjsipCallProxy : ICallProxyInterface
  {
    ...
    // call API
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "dll_makeCall")]
    private static extern int dll_makeCall(int accountId, string uri);
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "dll_releaseCall")]
    private static extern int dll_releaseCall(int callId);
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "dll_answerCall")]
    private static extern int dll_answerCall(int callId, int code);
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "dll_holdCall")]
    ...
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "dll_serviceReq")]
    private static extern int dll_serviceReq(int callId, int serviceCode, string destUri);
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "dll_dialDtmf")]
    private static extern int dll_dialDtmf(int callId, string digits, int mode);
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "dll_getCurrentCodec")]
    private static extern int dll_getCurrentCodec(int callId, StringBuilder codec);
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "dll_makeConference")]
