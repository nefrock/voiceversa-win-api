...
namespace Sipek.Sip
{
  ...
  public class pjsipStackProxy : IVoipProxy
  {
...
#else
    internal const string PJSIP_DLL = "vvAPICpp.dll";
#endif

    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "dll_init")]
    private static extern int dll_init();
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "dll_main")]
    private static extern int dll_main();
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl,EntryPoint= "dll_shutdown")]
    private static extern int dll_shutdown();
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl,EntryPoint="dll_setSipConfig")]
    private static extern void dll_setSipConfig(SipConfigStruct config);

    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl,EntryPoint= "dll_getCodec")]
    private static extern int dll_getCodec(int index, StringBuilder codec);
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl,EntryPoint= "dll_getNumOfCodecs")]
    ...
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "onDtmfDigitCallback")]
    private static extern int onDtmfDigitCallback(OnDtmfDigitCallback cb);
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "onMessageWaitingCallback")]
    private static extern int onMessageWaitingCallback(OnMessageWaitingCallback cb);
    [DllImport(PJSIP_DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "onCallReplaced")]
