...
extern "C" PJSIPDLL_DLL_API int dll_adjustRxVolume(int callId, float vol);
extern "C" PJSIPDLL_DLL_API int dll_adjustTxVolume(int callId, float vol);
extern "C" PJSIPDLL_DLL_API int dll_getCallDump(int callId, char *dump, int buflen);
...
extern "C" PJSIPDLL_DLL_API int dll_setSoundDevice(char* playbackDeviceName, char* recordingDeviceName);
extern "C" PJSIPDLL_DLL_API int dll_setSoundDeviceToDefault();
extern "C" PJSIPDLL_DLL_API int dll_refreshAudioDeviceList();
